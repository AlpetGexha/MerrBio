            ...
            <div class="p-6 text-zinc-900 dark:text-zinc-100">
                ...
                @if($this->cartItems->isEmpty())
                    <div class="text-center py-10">
                        ...
                        <h3 class="mt-2 text-xl font-medium text-zinc-900 dark:text-zinc-100">Your cart is empty</h3>
                        <p class="mt-1 text-zinc-500 dark:text-zinc-400">Add some products to your cart to complete checkout.</p>
                        <div class="mt-6">
