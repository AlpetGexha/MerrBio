        ...
        <div class="bg-white dark:bg-zinc-900 rounded-lg shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">{{ $item->product->description }}</p>
                            </div>
            ...
            <div class="p-6 bg-zinc-50 dark:bg-zinc-800">
                <div class="flex justify-between items-center">
                    <span class="text-lg font-medium text-zinc-900 dark:text-zinc-100">Total: {{ number_format($this->total, 2) }} USD</span>
